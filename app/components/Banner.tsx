        ...
        <div className="flex flex-col lg:flex-row items-center ">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Kartikey Tyagi</span>
                    </p>
                  </div>
              ...
              <Image
                src="/assets/me.png"
                alt="Kartikey Tyagi - Software Engineer and Designer"
                width={300}
                height={300}
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="">
              ...
              <p className="text-md text-white/80">
                Because great experiences need clean UI and powerful logic
                behind them.
              </p>
            </div>
          </div>
